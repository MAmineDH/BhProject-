...
const Sidebar = () => {
    return (
        <aside className="hidden w-64 bg-black md:block min-h-screen rounded-t-[12px] overflow-hidden">
            <div className="py-3 text-2xl uppercase text-center tracking-widest bg-white border-b-2 border-gray-800 mb-8">
                <a href="/dashboard" className="text-white"><img src={logo} alt="" srcSet="" /></a>
            </div>
            <nav className="text-sm text-gray-300">
                <ul className="flex flex-col">
                    ...
                    <li className="px-4 py-2 text-xs uppercase tracking-wider text-gray-500 font-bold">Request MANAGEMENT</li>
                    <li className="px-4 cursor-pointer hover:bg-gray-700">
                        <a className="py-3 flex items-center" href="/">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                                stroke="currentColor" className="w-4 mr-3">
                    ...
                    <li className="px-4 hover:bg-gray-700 rounded-lg transition-colors">
                        <a href="/EditProfile" className="py-3 flex items-center text-gray-300 hover:text-white">
                            <svg
                    ...
                    <li className="px-4 cursor-pointer hover:bg-gray-700">
                        <a href="/editprofile" className="py-2 flex items-center">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                                strokeWidth="1.5"
                                stroke="currentColor"
                                className="w-5 h-5 mr-2 text-gray-600 hover:text-red-600 transition-colors"
                            >
                                <path
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
